...
3. `ComStatsim.results` mit dem ursprünglichen Ergebnisobjekt vergleichen,
4. verbliebene Objekte mit Präfix `GridLens_TMP_` prüfen und gegebenenfalls
   kontrolliert entfernen,
5. Ursache beheben und den vollständigen Lauf wiederholen.
